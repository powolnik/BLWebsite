    ...
    <footer className="border-t border-[var(--color-dark-border)] bg-[var(--color-dark-surface)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4"><Zap className="w-6 h-6 text-[var(--color-neon-green)]" /><span className="text-xl font-bold gradient-text">SYNAPSE</span></div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[var(--color-text-secondary)]">
              <li className="flex items-center gap-2"><Mail className="w-4 h-4" /> hello@synapse-collective.pl</li>
              <li className="flex items-center gap-2"><MapPin className="w-4 h-4" /> Wroclaw, Polska</li>
              <li className="flex items-center gap-2"><Instagram className="w-4 h-4" /> @synapse.collective</li>
            </ul>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-[var(--color-dark-border)] text-center text-sm text-[var(--color-text-secondary)]">&copy; {new Date().getFullYear()} SYNAPSE Collective</div>
      </div>
    </footer>
  );
}
