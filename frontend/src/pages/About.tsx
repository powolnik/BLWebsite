    ...
    <div className="grid-bg py-24 px-4">
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">O <span className="gradient-text">SYNAPSE</span></h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-24">
          <div><h2 className="text-2xl font-bold mb-4">Nasza historia</h2><p className="text-[var(--color-text-secondary)]">SYNAPSE Collective powstalo z potrzeby tworzenia przestrzeni laczacych technologie z sztuka. Od 2020 roku projektujemy sceny i instalacje swietlne na festiwalach w calej Polsce.</p></div>
